...
var UHTEventBroker = function () {
    ...
    function parseOnlineConfig(config) {
        ...
        var gsPath = tmp.substring(tmp.indexOf("/"),
            tmp.lastIndexOf("/") + 1);
    ...
    function loadScript(url) {
        if (url.indexOf("build.js") == -1) url = UHT_CONFIG.GAME_URL + url + "?key=" + UHT_REVISION.uncommon;
        else url = UHT_CONFIG.GAME_URL + window["UHT_SCRIPTS_SIZE"].split(":")[0];
                    ...
                    if (xmlhttp.status == 200) {
                        ...
                        if (window["currentDatapathRetries"] >= window["retriesBeforeAlternativeDatapath"]) {
                            ...
                            if (!window["SENT_GA_EVENT_ALTERNATIVE_DATA_PATH"]) {
                                ...
                                window["globalTracking"]["SendEvent"]("uht_loading",
        ...
        xmlhttp.onprogress = function (progress) {
            if (progress["currentTarget"]["responseURL"].indexOf("build.js") != -1) {
                if (!window["UHT_CUSTOM_LOADER"]) document.getElementById("loadingBar").style.width = progress.loaded / UHT_GAME_SIZE * 70 + 1 + "%";
    ...
    function sendMessagesToGame() {
        if (gameLoaded) {
            for (var i = 0; i < messagesToGame.length; ++i) triggerEvent(EM.Type.Game,
                messagesToGame[i]);
            messagesToGame = []
    ...
    function onLoad() {
        ...
        isOnline = sendToAdapterOriginal !=
            null;
...
UHT_SCRIPTS_SIZE = 'build.js?key=ed3ef4fef17929d1f22bb2f49c319878:2895769,';
UHT_CLIENT_SIZES = 'game?key=c96b5e1fde8be138d77ef6ccae15cd2d:22159,resources?key=852908ba74628cba8d1c51b8f09022c0:126669,';
UHT_GAME_SIZE = 'game000?key=5ef0433381979a1006e22353107aaba1:1354559,game001?key=52ee7a602c928cf0087588b06743fe53:554222,';
UHT_RESOURCES_SIZE = 'main_resources000?key=fd04d681fce4f7bbc74aaa23e03c9377:726068,main_resources001?key=b2ef743c26354ae03387896afb5c6d14:716581,main_resources002?key=d5fbdb6ff8635106a9ceae07566bc7a9:538641,main_resources003?key=3ea4f77fd54de76d65a0e8b6de18fa61:599386,main_resources004?key=b0e7590daf9f72c654d09f455c3daa76:2025019,main_resources005?key=8d11cf67fa39cda8ee1633ddc895b62e:690910,';
UHT_OTHER_SIZE = 'other_resources000?key=f8066c906c3f58694dc0644deef7baa2:543519,other_resources001?key=31f91e8e2c6aa2d556ae97572a408b26:76448,';
